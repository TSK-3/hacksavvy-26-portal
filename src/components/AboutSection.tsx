      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            HACKSAVVY-26 is a 24-hour national-level hackathon organized by Mahatma Gandhi Institute of Technology (MGIT). 
            It's where brilliant minds come together to solve real-world problems through innovation, coding, and creativity.
          </p>
        </div>
